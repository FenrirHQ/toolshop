...
--
-- Host: tsuts.tskoli.is    Database: 1612972679_picturebase
-- ------------------------------------------------------
...
CREATE TABLE `categories` (
  ...
  UNIQUE KEY `categoryname_NQ` (`categoryName`)
...
CREATE TABLE `images` (
  ...
  PRIMARY KEY (`imageID`),
  KEY `image_category_FK` (`categoryID`),
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`userID`),
  UNIQUE KEY `username_NQ` (`userName`),
  UNIQUE KEY `useremail_NQ` (`userEmail`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database '1612972679_picturebase'
--

--
-- Dumping routines for database '1612972679_picturebase'
--
/*!50003 DROP FUNCTION IF EXISTS `SetAccessLevel` */;
...
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` FUNCTION `SetAccessLevel`(access_level tinyint,user_id int,admin_id int) RETURNS int(11)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` FUNCTION `ValidateUser`(user_name varchar(15),user_pass varchar(15)) RETURNS int(11)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `CategoryList`()
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `DeleteCategory`(category_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `DeleteImage`(image_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `DeleteUser`(user_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `GetCategory`(category_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `GetImage`(image_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `GetUser`(user_id int)
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ImageList` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `ImageList`()
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `NewCategory`(category_name varchar(45))
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `NewImage` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `NewImage`(image_name varchar(45),image_path varchar(255),image_text varchar(155),category_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `NewUser`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ResetUser` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `ResetUser`(user_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `UpdateCategory`(category_name varchar(45), category_id int)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `UpdateImage`(
	image_id int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `UpdateUser`(
	user_id int,
	first_name varchar(55),
	last_name varchar(55),
    user_email varchar(125),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`1612972679`@`%` PROCEDURE `UserList`()
begin
...
-- Dump completed on 2016-11-16 14:05:34
